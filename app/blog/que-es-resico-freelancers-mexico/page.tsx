...
export const metadata: Metadata = {
  ...
  robots: "index, follow",
  alternates: {
    canonical: "/blog/que-es-resico-freelancers-mexico",
    types: {
      ...
      <article className="container mx-auto px-6 lg:px-12 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-9 space-y-12">
            ...
            <CalculatorCTA 
              title="¿Te conviene cambiarte a RESICO?"
              description="Calcula tu ahorro fiscal potencial y compara tus impuestos actuales contra el esquema simplificado."
            />
          </div>
        </div>
      </article>
